...
public class ArmorMaterials {
	 ...
	 */
	public static final ArmorMaterial Gold2=EnumHelper.addArmorMaterial(			"Gold", "", 			7, 	new int[]{1,2,3,1}, 25, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0F);
	public static final ArmorMaterial Iron2=EnumHelper.addArmorMaterial(			"Iron", "", 			15, new int[]{2,5,6,2}, 9, 	SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0F);
	...
	public static final ArmorMaterial Mithril=EnumHelper.addArmorMaterial(			"Mithril", "", 			30, new int[]{3,6,8,3}, 35, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
	...
	public static final ArmorMaterial Alumite=EnumHelper.addArmorMaterial(			"Alumite", "", 			22, new int[]{2,6,8,2}, 7, 	SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F);
	...
	public static final ArmorMaterial Stellite=EnumHelper.addArmorMaterial(			"Stellite", "", 		32, new int[]{3,6,8,3}, 5, 	SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2.5F);
	...
	public static final ArmorMaterial Vibranium=EnumHelper.addArmorMaterial(		"Vibranium", "", 		48, new int[]{2,6,7,2}, 13, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
